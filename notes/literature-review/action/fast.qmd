...
FAST first normalises actions using fixed training-data quantiles, as explained in [Inputs, tokens, and normalisation](../../study-notes/machine-learning/quantile-normalization.qmd#quantile-scaling).
