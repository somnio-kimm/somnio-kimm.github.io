...
The shared study notes explain [attention weights](../../study-notes/machine-learning/attention.qmd#weights-and-values) and [LayerNorm](../../study-notes/machine-learning/normalisation.qmd#layernorm).
:::
