...
[CLIP](clip.qmd) can use a ViT image encoder while learning alignment with text.
[PaliGemma](../language/paligemma.qmd) supplies a sequence of visual features to a language model, rather than using only a class token for classification.
