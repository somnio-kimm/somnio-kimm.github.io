...
Its models include modified ResNets and [ViTs](vit.qmd), specifically ViT-B/32, ViT-B/16, and ViT-L/14, with an additional higher-resolution L/14 variant.
...
[DINO](dino.qmd) learns visual features without paired text, whereas CLIP's cross-modal supervision supports description-based retrieval and classification.
[PaliGemma](../language/paligemma.qmd) starts with a SigLIP image encoder and adds a generative language model.
