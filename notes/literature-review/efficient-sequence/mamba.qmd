...
description: 'A selective state-space model: linear-time sequence modelling with input-dependent
  SSM dynamics, HiPPO initialisation, and a parallel selective scan.'
categories:
- Efficient Sequence
---
